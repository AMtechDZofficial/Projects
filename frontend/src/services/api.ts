...
export const modelsApi = {
  ...
  getFull: (id: string) => api.get(`/models/${id}/full`),
  ...
  getPatternPieces: (id: string) => api.get(`/models/${id}/pattern-pieces`),
  addPatternPiece: (id: string, data: unknown) => api.post(`/models/${id}/pattern-pieces`, data),
  updatePatternPiece: (id: string, pieceId: string, data: unknown) => api.put(`/models/${id}/pattern-pieces/${pieceId}`, data),
  deletePatternPiece: (id: string, pieceId: string) => api.delete(`/models/${id}/pattern-pieces/${pieceId}`),
  getGradation: (id: string) => api.get(`/models/${id}/gradation`),
  addGradationRow: (id: string, data: unknown) => api.post(`/models/${id}/gradation`, data),
  updateGradationRow: (id: string, rowId: string, data: unknown) => api.put(`/models/${id}/gradation/${rowId}`, data),
  deleteGradationRow: (id: string, rowId: string) => api.delete(`/models/${id}/gradation/${rowId}`),
  getFittings: (id: string) => api.get(`/models/${id}/fittings`),
  upsertFitting: (id: string, data: unknown) => api.post(`/models/${id}/fittings`, data),
  getPrototype: (id: string) => api.get(`/models/${id}/prototype`),
  upsertPrototype: (id: string, data: unknown) => api.post(`/models/${id}/prototype`, data),
  getColorVariants: (id: string) => api.get(`/models/${id}/color-variants`),
  addColorVariant: (id: string, data: unknown) => api.post(`/models/${id}/color-variants`, data),
  updateColorVariant: (id: string, variantId: string, data: unknown) => api.put(`/models/${id}/color-variants/${variantId}`, data),
  deleteColorVariant: (id: string, variantId: string) => api.delete(`/models/${id}/color-variants/${variantId}`)
};
